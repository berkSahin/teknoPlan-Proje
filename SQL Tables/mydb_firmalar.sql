...
CREATE TABLE `firmalar` (
  `ID` int(11) NOT NULL,
  `fAd` varchar(45) DEFAULT NULL,
  `iKisi` varchar(45) DEFAULT NULL,
  `iTel` varchar(45) DEFAULT NULL,
  `iFaks` varchar(45) DEFAULT NULL,
  `iEmail` varchar(45) DEFAULT NULL,
  `iAdi` varchar(45) DEFAULT NULL,
  `uretici` binary(1) DEFAULT NULL,
  PRIMARY KEY (`ID`)
